...
ValueError: Unable to parse string "-7.0277543E"

During handling of the above exception, another exception occurred:

ValueError                                Traceback (most recent call last)
~/Documents/Kaggle/Google Smartphone Decimeter Challenge/scripts/furu/generate_Pixel4Modded.py in 
      215 gnss_section_names = {'Raw','UncalAccel', 'UncalGyro', 'UncalMag', 'Fix', 'Status', 'OrientationDeg'}
      216 path = '../../data/raw/test/2021-04-21-US-MTV-1/Pixel4Modded/Pixel4Modded_GnssLog.txt'
----> 217 df_dict = gnss_log_to_dataframes(path, gnss_section_names)

~/Documents/Kaggle/Google Smartphone Decimeter Challenge/scripts/furu/generate_Pixel4Modded.py in gnss_log_to_dataframes(path, gnss_section_names)
     116             if col == 'CodeType':
     117                 continue
---> 118             results[k][col] = pd.to_numeric(results[k][col])
     119 
    120     return results

~/.pyenv/versions/anaconda3-2020.11/envs/py37/lib/python3.7/site-packages/pandas/core/tools/numeric.py in to_numeric(arg, errors, downcast)
    153         try:
...
# train gnss log 確認用
gnss_section_names = {'Raw','UncalAccel', 'UncalGyro', 'UncalMag', 'Fix', 'Status', 'OrientationDeg'}
path = '../../data/raw/train/2021-01-04-US-RWC-1/Pixel4Modded/Pixel4Modded_GnssLog.txt'
df_dict = gnss_log_to_dataframes(path, gnss_section_names)
