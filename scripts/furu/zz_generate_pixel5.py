...
# %%
# パス
gt_train_path = '../../data/raw/train/*/Pixel5/ground_truth.csv'
dr_train_path = '../../data/raw/train/*/Pixel5/Pixel5_derived.csv'
...
# %%
# パス
dr_test_path = '../../data/raw/test/*/Pixel5/Pixel5_derived.csv'
...
# %%
# 保存
train_df.to_csv('../../data/interim/train/all_Pixel5_derived.csv', index=False)
test_df.to_csv('../../data/interim/test/all_Pixel5_derived.csv', index=False)
