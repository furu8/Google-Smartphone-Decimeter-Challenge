...
# train gnss log 確認用
gnss_section_names = {'Raw','UncalAccel', 'UncalGyro', 'UncalMag', 'Fix', 'Status', 'OrientationDeg'}
path = '../../data/raw/train/2020-05-14-US-MTV-1/Pixel4XLModded/Pixel4XLModded_GnssLog.txt'
...
"""
Pixel4XLModdedは時間の順番がおかしい箇所がいっぱい
Statusを実行するとわかる
"""
# %%
# UncalAccel
...
# %%
# UncalGyro
# 227489レコード目で時間が逆転してる
df_dict['UncalGyro'][df_dict['UncalGyro']['utcTimeMillis'].diff()<0]
df_dict['UncalGyro'].iloc[227485:227495]
