...
# train gnss log 確認用
gnss_section_names = {'Raw','UncalAccel', 'UncalGyro', 'UncalMag', 'Fix', 'Status', 'OrientationDeg'}
path = '../../data/raw/train/2021-01-04-US-RWC-2/Pixel5/rawPixel5_GnssLog.txt'
...
~/Documents/Kaggle/Google Smartphone Decimeter Challenge/scripts/furu/generate_Pixel5.py in 
      ...
      216 path = '../../data/raw/train/2021-01-04-US-RWC-2/Pixel5/Pixel5_GnssLog.txt'
----> 217 df_dict = gnss_log_to_dataframes(path, gnss_section_names)
      218 
      219 \"""

~/Documents/Kaggle/Google Smartphone Decimeter Challenge/scripts/furu/generate_Pixel5.py in gnss_log_to_dataframes(path, gnss_section_names)
     106             gnss_map[dataline[0]] = dataline[1:]
     107         elif not is_header:
---> 108             datas[dataline[0]].append(dataline[1:])
     109 
     110     results = dict()
...
# train gnss log 確認用
gnss_section_names = {'Raw','UncalAccel', 'UncalGyro', 'UncalMag', 'Fix', 'Status', 'OrientationDeg'}
path = '../../data/raw/test/2021-04-02-US-SJC-1/Pixel5/rawPixel5_GnssLog.txt'
df_dict = gnss_log_to_dataframes(path, gnss_section_names)
