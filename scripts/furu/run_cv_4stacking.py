...
def run_learing(drived_id, x_trn_df, x_tst_df, y_trn_df, y_tst_df, z_trn_df, z_tst_df, params):
    print(drived_id)
    if drived_id == 'SJC':
...
def main():
    ...
    for drived_id in cns_dict.keys():
        ...
        test_pred_df = run_learing(drived_id, x_trn_df, x_tst_df, y_trn_df, y_tst_df, z_trn_df, z_tst_df, model, params)
