...
# %%
# gnss_log 確認
train_gnss_df[train_gnss_df['millisSinceGpsEpoch'].diff()<0][['collectionName']]

"""
	        collectionName
303899	2021-04-28-US-SJC-1
451620	2021-04-29-US-SJC-2
"""

# %%
display(train_gnss_df.loc[303895:303905, ['millisSinceGpsEpoch', 'collectionName']])
display(train_gnss_df.loc[451615:451625, ['millisSinceGpsEpoch', 'collectionName']])
"""
collectionNameから、同じ日の車で時間順が前後している
"""
# %%
# train結合
